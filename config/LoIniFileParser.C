...
# define YYTOKENTYPE
   /* Put the tokens into the symbol table, so that GDB and other debuggers
      know about them.  */
   enum yytokentype {
     LOCD_IFP_OPENSEC = 258,
     LOCD_IFP_CLOSESEC = 259,
     LOCD_IFP_ASSOP = 260,
     LOCD_IFP_IDENTIFIER = 261,
     LOCD_IFP_VALUE = 262
   };
#endif
/* Tokens.  */
#define LOCD_IFP_OPENSEC 258
#define LOCD_IFP_CLOSESEC 259
#define LOCD_IFP_ASSOP 260
#define LOCD_IFP_IDENTIFIER 261
#define LOCD_IFP_VALUE 262




/* Copy the first part of user declarations.  */
#line 2 "src/Robots/LoBot/config/LoIniFileParser.y"
...
/* Line 216 of yacc.c.  */
#line 257 "src/Robots/LoBot/config/LoIniFileParser.C"
...
{
       9,     0,    -1,    10,    -1,     9,    10,    -1,    11,    -1,
      12,    -1,     3,     6,     4,    -1,     6,     5,     7,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,   151,   151,   151,   164,   164,   178,   187
};
#endif
...
{
  "$end", "error", "$undefined", "LOCD_IFP_OPENSEC", "LOCD_IFP_CLOSESEC",
  "LOCD_IFP_ASSOP", "LOCD_IFP_IDENTIFIER", "LOCD_IFP_VALUE", "$accept",
  "ini_file", "config_directive", "section_spec", "option_spec", 0
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 6:
#line 178 "src/Robots/LoBot/config/LoIniFileParser.y"
    {
  ...
  case 7:
#line 187 "src/Robots/LoBot/config/LoIniFileParser.y"
    {
...
/* Line 1267 of yacc.c.  */
#line 1458 "src/Robots/LoBot/config/LoIniFileParser.C"
      default: break;
    }
...
#line 191 "src/Robots/LoBot/config/LoIniFileParser.y"
